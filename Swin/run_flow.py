...
val_interval = 5
save_interval = 5
path_to_csl = "C:/uestc/code/TimeSformer-main/datasets/{}-{}-flow".format(dataset, num_classes)
result_path = "C:/uestc/code/TimeSformer-main/Swin/result/{}-{}-flow".format(dataset, num_classes)
log_path = "C:/uestc/code/TimeSformer-main/Swin/log/{}-{}-flow/train.log".format(dataset, num_classes)
sum_path = "C:/uestc/code/TimeSformer-main/Swin/run/{}-{}-flow".format(dataset, num_classes)
...
if __name__ == '__main__':
    if phase == "Train":
        train_set = Flow(data_path=path_to_csl, frames=num_frames,
            num_classes=num_classes, split="train")
        val_set = Flow(data_path=path_to_csl, frames=num_frames,
        ...
        test_set = Flow(data_path=path_to_csl, frames=num_frames,
