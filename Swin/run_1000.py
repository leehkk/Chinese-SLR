...
result_path = "C:/uestc/code/TimeSformer-main/Swin/result/{}-{}".format(dataset, num_classes)
log_path = "C:/uestc/code/TimeSformer-main/Swin/log/{}-{}/train.log".format(dataset, num_classes)
...
if __name__ == '__main__':
    ...
    # model.load_state_dict(torch.load(os.path.join(result_path,"best_swin_epoch020.pth")))
    print(model)
