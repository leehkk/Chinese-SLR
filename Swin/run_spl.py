...
path_to_csl = "{}/datasets/{}-{}".format(base_dir, dataset, num_classes)
result_path = "{}/result/{}-{}".format(base_dir, dataset, num_classes)
log_path = "{}/log/{}-{}/train.log".format(base_dir, dataset, num_classes)
sum_path = "{}/run/{}-{}".format(base_dir, dataset, num_classes)
